...
1. **Las aportaciones son grandes en términos relativos.** En diez años entran 120.000 €
   ...
   mensual en una herramienta de primera magnitud: **puede reducir la necesidad de vender
   para corregir desviaciones — sin garantizar que nunca haya que vender** *(capítulo 13;
   la política de ventas por sobreponderación sigue pendiente)*.
...
Convicción)*, con el techo de Convicción del 14% como presupuesto, no cuota. ⚠️ **La bolsa
del 47% se controla en las fechas de revisión, no de forma continua** — los movimientos
diarios de mercado no disparan ajustes.
...
| Elemento | Estado |
|---|---|
| **Función** | 🔒 **Estable por defecto** — cambiarla exige una decisión de arquitectura registrada; estable no significa inmutable |
| **Peso** | 🔧 Parametrizable |
...
| 2026-08-14 | **v2 — auditoría externa aplicada.** Funciones «estables por defecto, no inmutables» *(tabla maestra)*; la bolsa del 47% se controla **en fechas de revisión, no continuamente**; las aportaciones «**pueden reducir la necesidad de vender**, no garantizar que nunca haya que vender». La v1 se conserva |
