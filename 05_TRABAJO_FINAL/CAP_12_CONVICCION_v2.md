...
## Investment Book · Parte II · 🟢 **PROTOCOLO CERRADO v2** · evidencia de implementación pendiente *(IDC + Fecha Cero)* · 14-ago-2026 *(D86)*
...
decirlo así. El presupuesto de impacto es simétrico y se publica con sus dos caras —
⚠️ **y la cifra de ±0,7 puntos anuales corresponde EXCLUSIVAMENTE al caso de la capa
completamente desplegada al 14% con un diferencial de ±5 puntos**; con despliegues
menores el impacto es proporcionalmente menor *(al 7%: ±0,35)*.

**Condiciones técnicas de la comparación, registradas:** el exceso frente al Motor solo es
válido si se calcula con **la misma ventana temporal, la misma moneda y rentabilidad
total** *(dividendos incluidos)* en ambos lados. Sin las tres, la cifra no se publica.
...
| 2026-08-14 | **v2 — auditoría externa aplicada.** El ±0,7 acotado **exclusivamente** al caso de despliegue completo al 14% × diferencial de ±5 puntos; registradas las tres condiciones técnicas de la comparación acción vs Motor *(misma ventana, misma moneda, rentabilidad total)*. **La Fecha Cero sigue pendiente y no se inventa.** La v1 se conserva |
