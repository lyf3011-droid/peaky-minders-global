...
**reduciendo mucho la necesidad de vender** — con lo que el rebalanceo casi no genera
coste ni fricción. *(Reducir la necesidad no es eliminarla: el §13.4 declara el límite.)*
...
ENTRAN 1.000 €
   ...
   └─ NO → PASO 2 · ¿Hay algún módulo por debajo de su objetivo?
              ...
              │        Definición exacta (aprobada en D56): desviación =
              │        peso actual − peso objetivo, en puntos porcentuales
              │        sobre el total; gana el valor más negativo.
              │
...
- **Conexión con la bolsa del 47%:** en cada fecha de revisión se comprueba, además de los
  pesos por módulo, la identidad de gobernanza *(Motor ordinario + Reserva + Convicción =
  47%)* — **evaluada en revisión, no de forma continua** — y las aportaciones son la
  herramienta que la devuelve a su objetivo.

Ejemplo completo con números redondos: en un mes aparecen tres empresas en precio y se
ejecutan **tres compras de 1.000 € cada una = 3.000 €**, financiadas con **1.000 € de la
aportación + 2.000 € de la Reserva** *(por orden de descuento — cap. 12)*; **la Reserva
queda en 1.000 €**. Los meses
...
| 2026-08-14 | **v2 — auditoría externa aplicada.** «Sin vender nada» → «reduciendo mucho la necesidad de vender» con remisión al límite; **definición exacta de «mayor desviación negativa»** citando D56 *(peso actual − objetivo, en puntos porcentuales — fórmula ya aprobada en el protocolo, no inventada)*; conexión explícita de las aportaciones con la revisión de la bolsa del 47%; el ejemplo aclarado *(3 compras de 1.000 = 1.000 aportación + 2.000 Reserva → queda 1.000)*. **D47b permanece abierto.** La v1 se conserva |
