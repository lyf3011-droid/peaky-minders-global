...
**Por qué el 44%.** **El Motor reduce la dependencia de acertar con empresas concretas y
utiliza una exposición amplia al mercado como base de la cartera** — y es el peso mayor
porque es la función con más evidencia acumulada a su favor **[EVIDENCIA EXTERNA — SPIVA;
Bessembinder, pendientes de cita formal]**. La cifra exacta es parametrización *(cap. 10)*: suficiente para dominar el
...
las mayores compañías y su comportamiento está estrechamente ligado. **La sobreponderación
de EEUU es la tesis; el solapamiento es una consecuencia deliberada de su
implementación** — si no lo hubiera, no habría sobreponderación. Es un riesgo
...
**Qué aporta.** Beneficios más estables y, **[EVIDENCIA EXTERNA — comportamiento
histórico en recesiones pendiente de cita con fuente y periodo]**, históricamente mejores
caídas relativas en recesiones — sin garantía de que ocurra en todas *(regla del cap. 5)*.
...
sustituible, función estable. ⚠️ **Y la prima misma no se presenta como certeza: la
evidencia a su favor es histórica pero discutida, y menos robusta cuando no se controla
la calidad de las empresas** **[EVIDENCIA EXTERNA — literatura del factor tamaño y su
crítica, pendiente de cita]**.

**Qué aporta.** Exposición a primas distintas de la beta — y el multifactor europeo es,
además, **una sobreponderación europea específica dentro de Aceleración** *(su efecto
geográfico se mide, no se proclama — cap. 16)*.
...
**Qué aporta.** Estabilidad estratégica y rentas. ⚠️ **Separación absoluta con la
Reserva: el Freno NO es la caja rutinaria para financiar Convicción** — esa capacidad
operativa es la Reserva *(cap. 13)*; el Freno es asignación estratégica con función
propia.
...
**Solapamientos.** **Solapamiento directo reducido** con el resto de módulos — lo cual
**no implica independencia estadística**: las correlaciones se miden con su ventana y
fuente en el cap. 18.
...
| 2026-08-14 | **v2 — auditoría externa aplicada.** Motor: eliminado «la función que menos habilidad exige» → *reduce la dependencia de acertar con empresas concretas*; «la sobreponderación es la tesis; el solapamiento, consecuencia deliberada de su implementación». Defensivos: comportamiento histórico en recesiones marcado [EVIDENCIA EXTERNA]. Small caps: la prima de tamaño como evidencia histórica **discutida**, menos robusta sin controlar calidad. Multifactor: «sobreponderación europea específica», no «único contrapeso». Freno: separación absoluta con la Reserva. Activos Reales: «solapamiento directo reducido; no implica independencia estadística». La v1 se conserva |
